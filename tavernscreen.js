class TavernScreen extends ScreenView {
    ...
    constructor() {
        ...
        this.buttons.push(new Button({"active": true, "x": 500, "y": 150, "w": 100, "h": 30, "text": "Exit", "screen": this, "action":  this.exitScreen}));
        this.buttons.push(new Button({"active": true, "name": "refresh", "x": 180, "y": 550, "w": 100, "h": 30, "text": "Refresh", "screen": this, "action":  this.refresh}));
        this.buttons.push(new Button({"active": true, "name": "recruit", "x": 360, "y": 550, "w": 100, "h": 30, "text": "Recruit", "screen": this, "action":  this.recruit}));
    ...
    draw() {
        if(this.active) {
            ...
            ctx.fillText(this.name, this.x, this.y + 120);
    ...
    displayGeneral() {
        ...
        for(let x=0; x<this.availableGenerals.length; x++) {
            this.availableGenerals[x].draw(150, 150);
                
        }
    }

    refresh(self) {
        let generalLevel = getRandom(1,5);
